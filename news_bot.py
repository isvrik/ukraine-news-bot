...
# Сужено: требуется Ukraine + конкретная тема переговоров, либо Ukraine + имя
# ключевого переговорщика — вместо широкого списка через OR без ограничений
GOOGLE_NEWS_QUERY_EN = (
    'Ukraine ("peace talks" OR ceasefire OR "peace deal" OR negotiations) '
    "OR (Witkoff OR Kushner) Ukraine"
)
GOOGLE_NEWS_RSS_EN = (
